...
<body>
    <div class="login_container my-5">
        ...
        <div class="form_login">
            ...
            <form class="login_form" action="{{ url('/Customer/Account/RegisterPost') }}" method="POST">
                <div class="form_group">
                    <input class="form-control border-0 shadow"  name="name" placeholder="Name"/>
                    <span class="form-message text-danger">{{ empty($errors['name']) ? "" : $errors['name'] }}</span>
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    ...
                    <span class="form-message text-danger">{{ empty($errors['con_password']) ? "" : $errors['con_password'] }}</span>
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    <button class="btn_register" type="button" >           
                        <a href="{{ url('/Customer/Account/Login') }}">
                            Login Now
                        </a>
                    </button>
                </div>
