                    ...
                    <div class="ord_cart row ">
                        <div class="col_cart">
                            ...
                            <div class="total_cart">
                                <div class="product-price"><span class="total"><?= $cart['price'] * $cart["quantity"]?></span> VND</div>
                            </div>
                            <div class="action_cart">
                                <form action="<?= '/cart/update/' . $cart['id'] ?>"  method="POST">
                                    ...
                                    <div class="quantity_buttons mb-3">
                                        ...
                                        <input name="quantity" type="number" id="quantity" value=<?= $cart['quantity'] ?>  class="quantity_input">
                                        <button id="increase">+</button>
                                    </div>
                                    <div>
                                        <button style="background:transparent" type="submit"><i class="fa-solid fa-pen"></i></button>
                                        <a  href="<?= '/cart/remove/' . $cart['id'] ?>"><i class="fa-solid fa-trash"></i></a>
                                    </div>
                                </form>
...
@endsection
<script src="{{ asset('js/pages/Cart/hanleInfoToCheckout.js') }}"></script>
<script src="{{ asset('js/pages/Cart/updateCart.js') }}"></script>